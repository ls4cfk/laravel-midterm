        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <a href="{{url('admin')}}" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                ...
                <a href="{{url('admin/viewfood')}}" class="list-group-item list-group-item-action bg-transparent second-text active"><i
                        class="fas fa-project-diagram me-2"></i>Add Food Item</a>
            </div>
        </div>
        <!-- /#sidebar-wrapper -->
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Edit Food Item</h2>
                </div>
            ...
            <div class="container-fluid px-4">
                ...
                <form action="{{url('savedititem')}}" method="POST">
                @csrf
                <div class="row g-3 my-2">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="imageurl" value="{{$menu->image_url}}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <label for="" class="label" style="font-size:20px;font-weight:bold;">Position </label>
                            <input type="text" name="position" value="{{$menu->position}}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="category" id="category" class="form-control">
                                <option value="{{$menu->menu_category}}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <input type="hidden" name="menuid" value="{{$menu->id}}" class="form-control">
                        </div>
                    </div>
